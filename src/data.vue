<template>
  <div id="data">
    ...
    <div v-if="cordova && !cordova.deviceready" class="alert">
      ...
      <br /> Check the <a href="https://github.com/kartsims/vue-cordova#troubleshooting">Troubleshooting section</a> of vue-cordova's
      README.
    </div>
        ...
        plugins: {
          ...
          'cordova-plugin-device': function () {
            if (!Vue.cordova.device) {
              ...
              window.alert('Device : ' + Vue.cordova.device.manufacturer + ' ' + Vue.cordova.device.platform + ' ' +
